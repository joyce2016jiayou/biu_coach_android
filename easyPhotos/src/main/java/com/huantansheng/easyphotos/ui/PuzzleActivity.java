...
import com.huantansheng.easyphotos.models.puzzle.*;
...
//    public static void startWithPhotos(Fragment fragmentV, ArrayList<Photo> photos, String puzzleSaveDirPath, String puzzleSaveNamePrefix, int requestCode, boolean replaceCustom, @NonNull ImageEngine imageEngine) {
//        if (null != toClass) {
//            toClass.clear();
//            toClass = null;
//        }
...
//    public static void startWithPaths(Fragment fragmentV, ArrayList<String> paths, String puzzleSaveDirPath, String puzzleSaveNamePrefix, int requestCode, boolean replaceCustom, @NonNull ImageEngine imageEngine) {
//        if (null != toClass) {
//            toClass.clear();
//            toClass = null;
//        }
...
//    }
    ...
    public void onItemClick(String stickerValue) {
        if (stickerValue.equals("-1")) {
            if (fileTypeIsPhoto) {
                ...
                for (int i = 0; i < puzzleLayout.getAreaCount(); i++) {
                    ...
                    stickerModel.addTextSticker(this, getFragmentManager(), date, mRootView);
        ...
        stickerModel.addTextSticker(this, getFragmentManager(), stickerValue, mRootView);
    }
