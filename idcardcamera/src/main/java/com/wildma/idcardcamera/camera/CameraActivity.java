            ...
            public void onFinish(Bitmap bitmap) {
                ...
                if (FileUtils.createOrExistsDir(Constant.DIR_ROOT)) {
                    ...
                    if (mType == IDCardCamera.TYPE_IDCARD_FRONT) {
                        imagePath = buffer.append(Constant.DIR_ROOT).append(Constant.APP_NAME).append(".").append("idCardFrontCrop" + System.currentTimeMillis() + ".jpg").toString();
...
//                        }
                        ...
                        imagePath = buffer.append(Constant.DIR_ROOT).append(Constant.APP_NAME).append(".").append("idCardBackCrop" + System.currentTimeMillis() + ".jpg").toString();
