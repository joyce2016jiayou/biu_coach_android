...
public class TagAliasOperatorHelper {
        ...
        if (tagAliasBean.isAliasAction) {
            switch (tagAliasBean.action) {
                ...
                case ACTION_SET:
                    ...
                    j_push_mHandler.sendMessage(j_push_mHandler.obtainMessage(MSG_SET_ALIAS, tagAliasBean.alias));//设置别名
    ...
    private final Handler j_push_mHandler = new Handler() {
        @Override
        public void handleMessage(android.os.Message msg) {
            super.handleMessage(msg);
            switch (msg.what) {
                case MSG_SET_ALIAS:
                    Log.e(TAG, "设置别名" + "Set alias in handler.");
                    // 调用 JPush 接口来设置别名。
                    JPushInterface.setAliasAndTags(context,
                            (String) msg.obj,
                            null,
                            mAliasCallback);
                    Log.e("设置的别名","11111"+(String) msg.obj);
                    //JPushInterface.setAlias(context,1,(String) msg.obj);
                    break;
                default:
                    Log.e(TAG, "设置别名" + "Unhandled msg - " + msg.what);
            }
        }
    };
        ...
        public void gotResult(int code, String alias, Set<String> tags) {
            ...
            switch (code) {
                case 0:
                    ...
                    if ("".equals(SharedPreferencesHelper.get(context, AppConstants.IS_SET_ALIAS, ""))) {
                        SharedPreferencesHelper.put(context, AppConstants.IS_SET_ALIAS, alias);
                    } else {
                        SharedPreferencesHelper.remove(context, AppConstants.IS_SET_ALIAS);
                        SharedPreferencesHelper.put(context, AppConstants.IS_SET_ALIAS, alias);
                    }
                    break;
                case 6002:
                    ...
                    j_push_mHandler.sendMessageDelayed(j_push_mHandler.obtainMessage(MSG_SET_ALIAS, alias), 1000 * 60);
                    break;
                default:
