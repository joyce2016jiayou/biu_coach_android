package com.noplugins.keepfit.coachplatform.util.ui.toast;
...
public class SuperCustomToast {
    ...
    public void show(String msg, int layoutId, int rootId, Activity activity) {
        ...
        LayoutParams lp_WW1 = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
        layout = inflater.inflate(layoutId,
                (ViewGroup) activity.findViewById(rootId));
        layout.setLayoutParams(lp_WW1);
        TextView title = (TextView) layout.findViewById(R.id.title);
        title.setText(msg);
        title.setTextColor(defaultTextColor);
        long i = 500;
        show(layout, i, null, null);
    }
