package com.noplugins.keepfit.coachplatform.util.ui.erweima.encode;
...
public class CodeCreator {
    ...
    public static Bitmap createQRImage(String content, int w, int h, Bitmap logo) {
