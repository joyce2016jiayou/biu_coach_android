...
import com.noplugins.keepfit.coachplatform.bean.CoordinateBean;
...
public class BarVerticalAndPolylineChart extends BaseChart {
    ...
    private int textSizeCoordinate = (int) getResources().getDimension(com.openxu.cview.R.dimen.text_size_level_small); //坐标文字大小
    private int textColorCoordinate = getResources().getColor(com.openxu.cview.R.color.text_color_light_gray);
    private int textSizeTag = (int) getResources().getDimension(com.openxu.cview.R.dimen.text_size_level_small); //数值字体
    private int textColorTag = getResources().getColor(com.openxu.cview.R.color.text_color_light_gray);
    private int textSizeLable = (int) getResources().getDimension(com.openxu.cview.R.dimen.text_size_level_small); //lable字体
    private int textColorLable = getResources().getColor(com.openxu.cview.R.color.text_color_light_gray);
