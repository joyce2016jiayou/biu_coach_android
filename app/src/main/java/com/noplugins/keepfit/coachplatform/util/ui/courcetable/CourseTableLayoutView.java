...
public class CourseTableLayoutView extends LinearLayout {
    ...
    private class CourseFlag {
        public CourseModel course = null;
    ...
    private class OnClickCourseListener implements OnClickListener {
        ...
        private OnClickCourseListener(CourseModel course, int position, int day, int time) {
            this.course = course;
    ...
    private int getListSize(List<CourseModel> list) {
...
//        }
    ...
    public interface Click_item {
        void onClickCourse(View view, CourseModel course, int dataPosition, int dayPosition, int timePosition);
    }
}
