...
import com.noplugins.keepfit.coachplatform.adapter.GuideViewPagerAdapter;
...
//        SpUtils.putBoolean(getApplicationContext(),AppConstants.FIRST_PASSWPRD,true);
//        SpUtils.putBoolean(getApplicationContext(),AppConstants.FIRST_OPEN,true);
//        SpUtils.putBoolean(getApplicationContext(),AppConstants.FIRST_QUANYI,true);
